...
final class visible extends field{
	...
	function view(){
		$output="";
		$output .= "<input type='checkbox' onchange=' $.post( \"".URL."/update-field/".$this->table."/".$this->rid."?".$this->fieldname."=\"+(this.checked? 1 : 0) );;' name='".$this->fieldname."' id='".$this->fieldname."' value='1' ";
